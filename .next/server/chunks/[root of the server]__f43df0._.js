...
const blogSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    ...
    excerpt: {
        ...
        maxlength: [
            500,
            'Excerpt cannot be more than 500 characters'
        ]
    },
    content: {
        type: String,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/models/Blog.ts [app-route] (ecmascript)");
;
;
;
async function GET() {
...
async function POST(request) {
    try {
        ...
        const newBlog = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Blog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            title,
            excerpt,
            content,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(savedBlog, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f43df0._.js.map