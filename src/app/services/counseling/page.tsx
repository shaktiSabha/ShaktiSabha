  ...
  return (
    <div className="grid py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Quick Chat Section */}
        <div
          className="mb-16 bg-white/10 backdrop-blur-sm p-2 rounded-xl 
        ...
        >
          <div className="max-w-xl mx-auto text-center p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-br from-green-500/10 
        ...
        <div
          className="mb-5 bg-white/10 backdrop-blur-lg p-6 rounded-xl 
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
            ...
            <select
              className="w-full px-4 py-2 bg-gray-500 border border-white/10 rounded-lg
  text-white placeholder-gray-400 focus:border-pink-500/50 
  focus:ring-1 focus:ring-pink-500/50"
